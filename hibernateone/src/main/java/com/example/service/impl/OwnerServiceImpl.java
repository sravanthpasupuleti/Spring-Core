...
public class OwnerServiceImpl implements OwnerService{
    ...
    public void saveOwner(OwnerDTO ownerDTO) throws DuplicateOwnerException{
        Owner exitOwner = ownerRepository.findOwner(ownerDTO.getId());
        if (Objects.nonNull(exitOwner)) {
            throw new DuplicateOwnerException(String.format(PROPERTIES_CONFIG.getProperty(OWNER_ALREADY_EXITS), ownerDTO.getId()));
        }
